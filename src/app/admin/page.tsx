        ...
        <div className="px-6 py-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 pb-4 border-b border-gray-200">
            ...
            <div className="mt-4 md:mt-0 bg-[#001F33] text-white px-4 py-2 rounded-lg">
              <p className="font-medium">Welcome, {session.user?.name || 'Admin'}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-[#F8F9FA] p-4 rounded-lg border-l-4 border-[#C9A357]">
              ...
              <p className="text-sm text-gray-500 mt-2">From contact form submissions</p>
            </div>
            
            <div className="bg-[#F8F9FA] p-4 rounded-lg border-l-4 border-[#001F33]">
              <h3 className="text-lg font-semibold mb-1">Quote Requests</h3>
              <p className="text-3xl font-bold">0</p>
              <p className="text-sm text-gray-500 mt-2">From quote request form</p>
            </div>
            ...
            <div className="bg-[#F8F9FA] p-4 rounded-lg border-l-4 border-green-500">
              ...
              <p className="text-sm text-gray-500 mt-2">Active administrators</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
              ...
              <Link href="#" className="text-[#C9A357] hover:text-[#B08A3E] font-medium text-sm">
                Coming soon →
              </Link>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
              ...
              <p className="text-gray-600 mb-4">Update website content, images, and information.</p>
              <ul className="text-sm text-gray-500 space-y-2 mb-4">
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
              ...
              <Link href="/register" className="text-[#C9A357] hover:text-[#B08A3E] font-medium text-sm">
                Add new admin →
              </Link>
            </div>
          </div>
