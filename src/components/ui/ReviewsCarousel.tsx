      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-[#F8F9FA] p-6 rounded-lg shadow-md">
          ...
          <p className="text-gray-700 mb-4">
            "These guys were great, no nonsense, very professional. They
            repaired and replaced all damaged gutters on the property. Thanks to
            your team!"
          </p>
        ...
        <div className="bg-[#F8F9FA] p-6 rounded-lg shadow-md">
          ...
          <p className="text-gray-700 mb-4">
            "The whole experience was first rate. They stuck with their quote,
            showed up on time, did the work expeditiously and did a quality job.
            What else is there?"
          </p>
        ...
        <div className="bg-[#F8F9FA] p-6 rounded-lg shadow-md">
          ...
          <p className="text-gray-700 mb-4">
            "Quality service and friendly people. They were fast and solved my
            problem with expertise. Would recommend at any time."
          </p>
