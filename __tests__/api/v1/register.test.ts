...
describe('Registration Functionality', () => {
  ...
  it('should validate registration data correctly', () => {
    ...
    const invalidPasswordResult1 = registerSchema.safeParse(invalidPasswordData1);
    ...
    const invalidPasswordResult2 = registerSchema.safeParse(invalidPasswordData2);
    ...
    const invalidPasswordResult3 = registerSchema.safeParse(invalidPasswordData3);
